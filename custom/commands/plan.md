...
1. Create `conductor/tracks/<track_id>/intent.md` with:
...
1. **Save plan to `conductor/tracks/<track_id>/plan.md`:**

```markdown
# Session Plan

**Created:** [timestamp]
**Intent Contract:** See conductor/tracks/<track_id>/intent.md
...
```
✅ Plan saved to conductor/tracks/<track_id>/plan.md
...
- Save plan and exit
- User can review `conductor/tracks/<track_id>/plan.md` at their leisure
...
- Creating and saving the plan (`conductor/tracks/<track_id>/plan.md`)
- Creating the intent contract (`conductor/tracks/<track_id>/intent.md`)
...
2. Creates `conductor/tracks/<track_id>/intent.md` (inside a Conductor-style track folder `shortname_YYYYMMDD`)
