...
When the user invokes this command (e.g., `/mp:review <arguments>`):
...
```
Skill(skill: "mp:review", args: "<user's arguments + context>")
```

**✗ INCORRECT - Do NOT use Task tool:**
```
Task(subagent_type: "mp:review", ...)  ❌ Wrong! This is a skill, not an agent type
```
...
- **Quick Review**: Pre-commit checks (use `/mp:quick-review` or just say "quick review")
