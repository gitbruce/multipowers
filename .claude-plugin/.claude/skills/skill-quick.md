...
```bash
/mp:quick "add dark mode toggle to settings"
```
...
/mp:quick "fix the broken import in auth.ts"
...
**User Request:**
```
/mp:quick "fix typo in README - change 'recieve' to 'receive'"
```
...
- For research: /mp:discover "research authentication patterns"
- For planning: /mp:define "define auth requirements"
- For building: /mp:develop "implement auth system"
- For validation: /mp:deliver "validate auth implementation"
...
→ Quick mode is for known solutions only. Use /mp:discover for research.

### "Multiple files need changes"
→ Consider /mp:develop for coordinated multi-file changes.
