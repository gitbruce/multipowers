...
```bash
/mp:extract ./my-app --mode design --storybook true
```

### Deep Analysis with Multi-AI
```bash
/mp:extract ./my-app --depth deep --multi-ai force
```

### URL Extraction
```bash
/mp:extract https://example.com --mode design --depth quick
```

## Integration with Other Skills

- **/mp:review**: Review extracted outputs for quality
- **/mp:deliver**: Validate extraction completeness
- **/mp:docs**: Generate additional documentation from extractions
