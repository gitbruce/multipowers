...
**Trigger:** `/mp:issues` or `/mp:issues list`
...
**Trigger:** `/mp:issues add <description>`
...
View with: /mp:issues show ISS-20260203-003
```
...
Use `/mp:issues list` to see all open issues.
```
...
View with: /mp:issues show ISS-20260203-001
```
...
**Actions:**
- Resolve: `/mp:issues resolve ISS-20260203-001`
```
