...
### Selection of Intent
When you run `./bin/octo config`, you can select specialized intents (choices 11, 12, 13) which sets your default persona and primary companion.
